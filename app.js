...
let newSum = (a, b, c, d) => {return a + b + c + d;};

// TODO: Uncomment the following line of code to see the output in the browser console

console.log(newSum(1, 2, 3, 4));

let newObjectLit = () => { return { key1: 'value1', key2: 'value2', key3: 'value3', }; };
...
{ let newName = name; let newAge = age; let newHometown = hometown; return[newName, newAge, newHometown]; };

let newJoe = new NewStudent('Joe', 100, 'Schmoe');
...
let greetingNew = () => `Hi, my name is ${joe.name}`;
...
let courseNameNew = () =>'This student is enrolled in Code 301.';
console.log(courseNameNew());
...
// since it refers to the space inside the parent and it is the Window in our example.